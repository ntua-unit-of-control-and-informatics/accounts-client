...
import { IEucliaAccounts, EucliaAccountsFactory} from '../src/EucliaAccounts'
import {User, } from '../src/models/user'

describe('client', function() {
    const accClient:IEucliaAccounts = new EucliaAccountsFactory("https://accountsapi.jaqpot.org").getClient();
    ...
    it('Testing getting organization', function() {
        let org = accClient.getOrganization('TqKqs0m8v26mji68', "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJ3Ujh3X1lGOWpKWFRWQ2x2VHF1RkswZkctQXROQUJsb3FBd0N4MmlTTWQ4In0..nSRkXy4WdAA2DyqFpPrxkHuYH5YxoxQkaWx8nthvQkMd_itiiYOftrWr0ez7KPc9y2Fba8vYqoBEmsVgUUce5YEQ6vgujbFWiwDB5mXPRvdQc2D9Ktq-eh7iPSjJKXpQTLcrN39ovGo6LcHNjB6KAGWmVp0aFck0l6ZZcVSX2QcvDSWfAp3HEs2coPC1NrcDfToLJmsJaKIpOypFrorpeY9iMZmX2B_WEwzIbl2sf9sd3w-ifNGRd1ehGmuAhMYpMq98eyWSyBTT18TKDCNznM8JA0waXr6kuqUkc_i73GepXMUHraqlXKvAbqTzNnX3nwTowXSGFzhwSh5b-ak99g")
        org.then(resp => {
            console.log(resp)
            expect(resp._id).to.equal("TqKqs0m8v26mji68")
        })
